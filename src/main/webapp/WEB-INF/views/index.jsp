...
<body style="background-image: url('resources/Images/bp.png');background-repeat: no-repeat; background-size: cover;">
	<!-- 
######################################################### HEADER ##########################################################
 -->
		...
		<nav class="navbar navbar-inverse">
			<div class="container-fluid">
				<div class="navbar-header">
					<a class="navbar-brand" href="index">PeachTree Boutique</a>
				</div>
 ...
 -->				
  ...
  <div class="panel-body">
	...
	<c:when test="${IfLoginClicked}">
		<c:import url="/WEB-INF/views/loginn.jsp">
		</c:import>
	</c:when>
	
	<c:when test="${IfRegisterClicked}">
		<c:import url="/WEB-INF/views/registrationn.jsp">
		</c:import>
	</c:when>
	</c:choose>
...
<!-- <h1>"Style is a way to say who you are without having to speak"!</h1>
		<div style="background-color:#FFB6C1; color:pink ; padding:0px;">
 ...
 -->
      ...
      <div class="item active">
        <img src="C:\Users\HP\Desktop\longdress.jpg" alt="longdress" width="800" height="800">
      </div>

      <div class="item">
        <img src="C:\Users\HP\Desktop\eartops.jpg" alt="eartops" width="800" height="800">
      </div>
    
      <div class="item">
        <img src="C:\Users\HP\Desktop\gift-card.jpg" alt="gift-card" width="800" height=800">
      </div>
       <div class="item">
        <img src="C:\Users\HP\Desktop\rings.jpg" alt="rings" width="800" height=800">
      </div>
       <div class="item">
        <img src="C:\Users\HP\Desktop\necklace.jpg" alt="necklace" width="800" height=800">
      </div>
							</div>
						...
						<ul>
							<c:forEach items="${productList}" var="product">
								...
								<li><a href=" ${product.name}" class="w3-hover-none"><img
										alt="${product.id}" height="200px" width="200px"
							...
							<div class="col-md-3 col-sm-6">
								<div class="widget">
									...
									<ul>
										...
										<li><a href="#">affiliative program</a></li>
							...
							<div class="col-md-3 col-sm-6">
								<div class="widget">
									...
									<ul>
										...
										<li><a href="#">whish list search</a></li>
